...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 02, 2020 at 08:49 AM
...
CREATE TABLE `projects` (
  ...
  `drive_link` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `project_status` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sale_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `projects` (`id`, `name`, `email`, `client_name`, `contact_number`, `drive_link`, `url`, `website`, `project_status`, `sale_id`, `address`, `start_date`, `cost`, `created_at`, `updated_at`) VALUES
(1, 'new projects 1234', 'sam1234@icloud.com', 'sam2234', '44 99154 823781234', 'drive.com234', 'ihas.in234', 'Rebuilt', '2', 'sale.id', 'asasa1234', '2020-10-28', '1300', '2020-10-27 05:31:57', '2020-10-29 08:48:52');
...
(29, 'employee1', 'admin1@org.com', 'justin', 'lee', 'ab', 'Male', '1', '7899456656', '3216547889', '9', NULL, 1, NULL, '$2y$10$5aGQ7tQGwxhODjFRceEWF.wCtRX3TQ3qANWI/bmP/K2Gkuf7miiwK', NULL, '2020-09-02 23:03:02', '2020-10-09 00:20:16'),
